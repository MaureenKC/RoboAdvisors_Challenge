    ...
    if age is not None:
        ...
        if age <= 0:
            return build_validation_result(
                False, 
                "Age",
                "You should be more than 0 years old or less than 65 years old to use this service,"
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False ,
                "investment_amount",
                "The investment_amount should be greater than or equal to 5000,"
                "Please provide enough investment amount.",
                )
